...
- Niche domain-specific knowledge goes to a project skill, not this file: to a matching already-extracted skill (Herdr integration, notification hooks — see the project-skills paragraph under Symlink Strategy), or a new `.claude/skills/<name>/SKILL.md` for a new domain. Keep this file to broadly-relevant guidance, and when working in a skill-covered domain start by reading its `SKILL.md`.
