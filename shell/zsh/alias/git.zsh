...
alias phc='ph create'
alias phcn='phc --tmux'
# ※verticalで水平に、horizontalで垂直分割になるので逆にする
alias phch='phc --tmux-vertical'
alias phcv='phc --tmux-horizontal'
...
alias phon='pho --tmux'
# ※verticalで水平に、horizontalで垂直分割になるので逆にする
alias phoh='pho --tmux-vertical'
alias phov='pho --tmux-horizontal'
