...
source_and_zcompile_if_needed "${SET}shell/zsh/alias/ai/codex.zsh"
source_and_zcompile_if_needed "${SET}shell/zsh/alias/ai/ai.zsh"
...
source_and_zcompile_if_needed "${SET}shell/zsh/alias/herdr.zsh"
