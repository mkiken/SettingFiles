...
#### 🟡 Medium Priority
6. **[path/to/file.ext:line]** Test Coverage: Short summary
...
If at least one actionable finding remains, display the following message to the user after outputting the review results and cleaning up:
