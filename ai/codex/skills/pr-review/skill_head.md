...
<!-- GENERATED FILE NOTICE: SKILL.md is generated by mac/initialization/ai/codex.sh (and mac/updates/codex.sh) from skill_head.md + ai/common/pr_review_core.md + skill_tail.md. Edit those sources, not SKILL.md. -->
