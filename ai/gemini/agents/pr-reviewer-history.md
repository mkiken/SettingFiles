...
Use the parent-provided PR metadata, full diff, line-numbered diff, existing comments NDJSON, local-mode flag, and repo owner/name. For history, use `run_shell_command` with commands such as:
