...
1. Derive a short English slug from the task prompt: lowercase ASCII letters, digits, and hyphens only; collapse separators and trim leading or trailing hyphens. Use `task` if no meaningful slug remains.
