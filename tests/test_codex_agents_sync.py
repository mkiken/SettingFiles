...
class GenerateCodexAgentsSyncTest(unittest.TestCase):
    ...
    rule + codex_base.md の単純連結と一致することを保証する。
    ...
    genshijin rule + 空行 + codex_base）を Python 側で再現し、コミット済み
    _AGENTS.md と突き合わせる。
    """
    ...
    def test_committed_agents_md_matches_concatenation_of_sources(self):
        ...
        self.assertEqual(
            ...
            "after editing prompt_base.md / genshijin-activate.md / codex_base.md",
        )
